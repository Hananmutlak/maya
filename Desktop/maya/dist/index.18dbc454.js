...
async function loadcours() {
    try {
        ...
        if (!response.ok) throw new Error("fel vid h\xe4mtning av data..");
...
function filterData() {
    ...
    const filteredData = cours.filter((course)=>course.code.toLowerCase().includes(search) || course.coursename.toLowerCase().includes(search));
